 ...
 * @version     V1.0
 * @date        2026-04-01
 * @brief       MPU6050/MPU6500 软件I2C驱动代码
 */
...
/* 软件I2C发送一个字节 */
static void MPU_IIC_Send_Byte(uint8_t dat)
{
    uint8_t t;
...
uint8_t MPU_Init(void)
{
    ...
    // MPU6050返回0x68, MPU6500返回0x70, 正点原子ATKMPU6050可能返回0x68或0x70
    if(res==MPU_ADDR || res==0x70 || res==0x71)//器件ID正确(兼容多种芯片)
    {
